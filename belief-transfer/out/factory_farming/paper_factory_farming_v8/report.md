...
- experiment `factory_farming`, run `paper_factory_farming_v8`
- code revision `46aad61`, config sha `20cb294cabc7`
- stages run: `writeup`
- lifetime LLM cost across those stages: $0.12
